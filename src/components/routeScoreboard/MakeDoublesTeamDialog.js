...
export default function MakeDoublesTeamDialog({ doublesTeamOpen, handleDoublesTeamClose }) {
    ...
    <div>
      <Dialog disableEscapeKeyDown open={doublesTeamOpen} onClose={handleDoublesTeamClose}>
        ...
        <DialogContent>
          <Box component="form" sx={{ display: 'flex', flexWrap: 'wrap' }}>
            <FormControl sx={{ m: 1, minWidth: 120 }}>
              <InputLabel htmlFor="demo-dialog-native">チーム１</InputLabel>
              <Select
                native
                value={age}
        ...
        <DialogActions>
          ...
          <Button onClick={handleDoublesTeamClose}>Ok</Button>
        </DialogActions>
      </Dialog>
    </div>
  );
