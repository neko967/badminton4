    ...
    <div className="scoreSheet">
      <Box sx={{ display: 'fix', flexWrap: 'wrap', '& > :not(style)': { m: 1, width: 1800, height: 110, }, }} >
        ...
        <div className="board-row">
          ...
          <LeftPointInScoreSheet squares={currentSquares[0]}/>
        </div>
        <Divider />
        <div className="board-row">
          <button className="nameSquare">Player C</button>
          <button className="square">R</button>
          <RightPointInScoreSheet squares={currentSquares[1]}/>
        </div>
        </Paper>
      </Box>
    </div>
...
function LeftPointInScoreSheet ({squares})  {
...
function RightPointInScoreSheet ({squares})  {
